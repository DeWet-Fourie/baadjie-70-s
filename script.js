...
/* ---------------- PRODUCT UNIQUE RETRO BACKGROUNDS ---------------- */
...
function applyProductBackgrounds(){
...
const productBackgroundObserver = new MutationObserver(() => {
  applyProductBackgrounds();
});

if (grid) {
  productBackgroundObserver.observe(grid, { childList: true });
}
